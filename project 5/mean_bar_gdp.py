...
wt_prefix = "gdp_bound_wt_analysis"
mut_prefix = "gdp_bound_q61r_analysis"
...
ax.set_title('Average distances from residue 61: GDP-bound WT vs Q61R')
ax.set_xticks(x)
ax.set_xticklabels(common_resids)
ax.legend()
plt.tight_layout()
plt.savefig('gdp_wt_q61r_paired_bar.png', dpi=300, bbox_inches='tight')
plt.show()
